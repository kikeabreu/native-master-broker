                ...
                {ventas.map((v,i)=>{
                  ...
                  <div key={v.id} style={{background:"#07070f",border:"1px solid #10b98133",borderRadius:10,padding:16}}>
                    ...
                    <div style={{marginTop:10}}>
                      <label style={S.lbl}>Fecha de cierre</label>
                      <input type="date" style={S.inp} value={v.fechaInicio||""} onChange={e=>updVenta(v.id,"fechaInicio",e.target.value)}/>
                    </div>
                    ...
                    {v.tipo==="financiado"&&(
                      <div style={{marginTop:14,padding:14,background:"#0b0b18",borderRadius:8,display:"flex",flexDirection:"column",gap:12}}>
                        ...
                        {/* Plazo y tasa */}
                        <div style={S.g2}>
                          <div><label style={S.lbl}>Plazo (meses)</label><input type="number" style={S.inp} placeholder="Ej. 60" value={v.plazoMeses||""} onChange={e=>updVenta(v.id,"plazoMeses",e.target.value)}/></div>
                          <div><label style={S.lbl}>Tasa anual (%)</label><input type="number" style={S.inp} placeholder="Ej. 12" value={v.tasaAnual||""} onChange={e=>updVenta(v.id,"tasaAnual",e.target.value)}/></div>
                        </div>
