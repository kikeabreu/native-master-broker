...
export default function ReporteAdmin() {
    ...
    const userStats = useMemo(() => {
        return profiles.map((p, pi) => {
            ...
            const revenue = uPros.filter(pr => pr.venta?.monto).reduce((s, pr) => s + Number(pr.venta.monto) * Number(pr.venta.plazo || 1), 0);
            ...
            return {
                ...
                newPros, byTab, closed, revenue, convRate, ticketProm,
